...
life[, Country:= ifelse(Country=="United Kingdom of Great Britain and Northern Ireland", "United Kingdom", Country)]
life[, Country:= ifelse(Country=="Democratic People's Republic of Korea", "Korea", Country)]
life[, Country:= ifelse(Country=="Democratic Republic of the Congo", "Congo", Country)]
...
new_life %>% filter(Country !="Tuvalu" & Country!="Marshall Islands")%>%
  plot_ly(x=~mean_Schooling, y=~mean_life_expectancy, type="scatter",  mode='markers', color=~Country, size=~mean_BMI,
          sizes=c(3,25), marker=list(sizemode='diameter', opacity=1),
          hover_info="text", text=~paste(paste0("Country: ", Country),
                                         paste0("Schooling: ", mean_Schooling),
